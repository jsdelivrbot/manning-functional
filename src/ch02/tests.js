/**
  ...
  Author: Luis Atencio
	...
	TO RUN:
	node 'C:\Sandpit\functional-programming-js\node_modules\qunit\bin\cli.js' -t 'src\ch02\tests.js' -c 'src\ch02\tests.js'
...
QUnit.test("Playing with immutable value objects", function () {
	...
	//console.log(isObject(princetonZip)) // => true
});
...
QUnit.test("Playing with Lenses", function () {
	...
	//console.log((R.view(zipLens, student)))
	//console.log(z)
	...
	console.info(R.view(zipLens, newStudent).toString()); //-> zipCode('90210', '5678')
	console.info(R.view(zipLens, student).toString()); //-> zipCode('08544', '1234')
